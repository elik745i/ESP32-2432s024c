...
Touch_CST820::Touch_CST820(int8_t sda_pin, int8_t scl_pin, int8_t rst_pin, int8_t int_pin)
{
    _sda = sda_pin;
    _scl = scl_pin;
    _rst = rst_pin;
...
bool Touch_CST820::getTouch(uint16_t *x, uint16_t *y, uint8_t *gesture)
{
